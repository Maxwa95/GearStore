...
namespace Gearstore.Controllers
{
    ...
    public class AccountController : ApiController
    {
       ...
       [AllowAnonymous]
        [Route("Login")]
        public IHttpActionResult Login([FromBody] TokenData mod)
        {
            ...
            {
                var response = client.PostAsync("http://localhost:60373/token", content).Result;
        ...
        public async Task<IHttpActionResult> Register([FromBody]RegisterBindingModel model)
        {
            ...
            IdentityResult x = await UserManager.CreateAsync(user,model.Password);
            if (x.Succeeded)
            {
